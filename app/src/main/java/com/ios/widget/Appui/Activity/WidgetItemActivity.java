...
import com.ios.widget.Appprovider.LargeWidgetProvider;
import com.ios.widget.Appprovider.MediumWidgetProvider;
import com.ios.widget.Appprovider.SmallWidgetProvider;
...
public class WidgetItemActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private int TabPos;
    private ArrayList<AppWidgetModel> modelArrayList = new ArrayList<>();
