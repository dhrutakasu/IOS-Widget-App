package com.ios.widget.cropiwa.config;
...
import com.ios.widget.cropiwa.shape.CropIwaOvalShape;
import com.ios.widget.cropiwa.shape.CropIwaRectShape;
import com.ios.widget.cropiwa.shape.CropIwaShape;
import com.ios.widget.cropiwa.util.ResUtil;
...
public class CropIwaOverlayConfig {
    ...
    public static CropIwaOverlayConfig createDefault(Context context) {
        ...
        CropIwaOverlayConfig config = new CropIwaOverlayConfig()
                ...
                .setBorderStrokeWidth(r.dimen(com.intuit.sdp.R.dimen._1sdp))
                .setCornerStrokeWidth(r.dimen(com.intuit.sdp.R.dimen._4sdp))
                .setCropScale(DEFAULT_CROP_SCALE)
                .setGridStrokeWidth(r.dimen(com.intuit.sdp.R.dimen._1sdp))
                .setMinWidth(r.dimen(com.intuit.sdp.R.dimen._40sdp))
                .setMinHeight(r.dimen(com.intuit.sdp.R.dimen._40sdp))
