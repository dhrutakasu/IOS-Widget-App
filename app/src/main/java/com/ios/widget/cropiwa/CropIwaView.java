package com.ios.widget.cropiwa;
...
import com.ios.widget.cropiwa.config.ConfigChangeListener;
import com.ios.widget.cropiwa.config.CropIwaImageViewConfig;
import com.ios.widget.cropiwa.config.CropIwaOverlayConfig;
import com.ios.widget.cropiwa.config.CropIwaSaveConfig;
import com.ios.widget.cropiwa.image.CropArea;
import com.ios.widget.cropiwa.image.CropIwaBitmapManager;
...
import com.ios.widget.cropiwa.util.CropIwaLog;
import com.ios.widget.cropiwa.util.LoadBitmapCommand;
...
//        imageView.setBackgroundColor(Color.BLACK);
    ...
    public void crop(CropIwaSaveConfig saveConfig, CropActivity cropActivity, CropIwaResultListener resultListener) {
        ...
        CropIwaBitmapManager.get().crop(
                ...
                imageUri, saveConfig,cropActivity,resultListener);
    }
    ...
    private class CropResultRouter implements CropIwaResultListener {
