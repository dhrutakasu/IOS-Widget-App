...
public class CropIwaResultReceiver extends BroadcastReceiver {
    ...
    public static final String ACTION_CROP_COMPLETED = "cropIwa_action_crop_completed";
    ...
    private CropIwaResultListener listener;
    ...
    public void setListener(CropIwaResultListener listener) {
