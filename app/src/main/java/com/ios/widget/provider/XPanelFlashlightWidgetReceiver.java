...
public class XPanelFlashlightWidgetReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (isLightOn) {
            views.setImageViewResource(R.id.IvTorch, R.drawable.ic_tourch1_selected);
        } else {
            views.setImageViewResource(R.id.IvTorch, R.drawable.ic_tourch1);
        }
