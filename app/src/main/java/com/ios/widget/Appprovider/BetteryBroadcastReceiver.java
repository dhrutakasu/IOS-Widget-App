...
public class BetteryBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intentReceiver) {
        ...
        int currentMonth;
        int currentYear;
        for (int i = 0; i < appWidgetData.size(); i++) {
            if (appWidgetData.get(i).getPosition() == 0) {
                if (appWidgetData.get(i).getType() == 0) {
                    ...
                    appWidgetManager.updateAppWidget(appWidgetData.get(i).getNumber(), rv);
                ...
                } else if (appWidgetData.get(i).getType() == 1) {
                    //todo clock 3 medium
                    ...
                    intent.putExtra(AppWidgetManager.EXTRA_APPWIDGET_ID, appWidgetData.get(i).getNumber());
                    intent.putExtra("TypeId", appWidgetData.get(i).getPosition());

                    intent.setData(Uri.parse(intent.toUri(Intent.URI_INTENT_SCHEME)));
                    rv.setRemoteAdapter(appWidgetData.get(i).getNumber(), R.id.GridCalendarMediumView, intent);
                    startMillis = Calendar.getInstance().getTimeInMillis();
                    builder = CalendarContract.CONTENT_URI.buildUpon();
                    builder.appendPath("time");
                    ContentUris.appendId(builder, startMillis);
                    ...
                    if (!new MyAppPref(context).getString(MyAppPref.IS_TIME_3, "").equalsIgnoreCase(currentDay + "/" + currentMonth + "/" + currentYear)) {
                        appWidgetManager.notifyAppWidgetViewDataChanged(appWidgetData.get(i).getNumber(), R.id.GridCalendarMediumView);
                    ...
                    PendingIntent broadcast = PendingIntent.getBroadcast(context, 0, alarmIntent, PendingIntent.FLAG_IMMUTABLE | PendingIntent.FLAG_UPDATE_CURRENT);
                    alarmManager.set(AlarmManager.RTC_WAKEUP, System.currentTimeMillis() + 2000, broadcast);
                } else if (appWidgetData.get(i).getType() == 2) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                        ...
                        cameraManager.registerTorchCallback(new CameraManager.TorchCallback() {
                            ...
                            public void onTorchModeChanged(@NonNull String cameraId, boolean enabled) {
                                ...
                                AppWidgetManager appWidgetManager = (AppWidgetManager) context.getSystemService(AppWidgetManager.class);
                                appWidgetManager.updateAppWidget(appWidgetData.get(finalI).getNumber(), finalRv);
                            }
                    ...
                    intent2.putExtra(AppWidgetManager.EXTRA_APPWIDGET_IDS, appWidgetData.get(i).getNumber());
            ...
            } else if (appWidgetData.get(i).getPosition() == 1) {
                if (appWidgetData.get(i).getType() == 0) {
                            ...
                            for (String provider : providers) {
                                ...
                                if (locationGPS != null) {
                                    try {
                                        ...
                                        String url, tempExt;
                                        if (appWidgetData.get(i).getTemp() == 0) {
            ...
            } else if (appWidgetData.get(i).getPosition() == 2) {
                if (appWidgetData.get(i).getType() == 0) {
                    //todo clock 9 small
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                        ...
                        manager.registerTorchCallback(new CameraManager.TorchCallback() {
                            ...
                            public void onTorchModeChanged(@NonNull String cameraId, boolean enabled) {
                                super.onTorchModeChanged(cameraId, enabled);
                                IsTorchOn = enabled;
                                if (appWidgetData.get(finalI).getType() == 2) {
                                    if (IsTorchOn) {
                                        finalRv.setImageViewResource(R.id.IvTorch, R.drawable.ic_tourch1_selected);
                                    } else {
                                        finalRv.setImageViewResource(R.id.IvTorch, R.drawable.ic_tourch1);
                    ...
                    if (appWidgetData.get(i).getType() == 2) {
                        if (MyAppConstants.IsWIfiConnected(context)) {
                            rv.setImageViewResource(R.id.IvWifi, R.drawable.ic_wifi1_selected);
                        } else {
                            rv.setImageViewResource(R.id.IvWifi, R.drawable.ic_wifi1);
                    ...
                    String city = appWidgetData.get(i).getCity();
                    ...
                    if (appWidgetData.get(i).getTemp() == 0) {
                        url1 = MyAppConstants.BASE_URL_FORECAST + appWidgetData.get(i).getCity() + "&cnt=6&units=metric&APPID=" + context.getString(R.string.str_weather_key);
                        tempExt1 = "°C";
                    } else {
                        url1 = MyAppConstants.BASE_URL_FORECAST + appWidgetData.get(i).getCity() + "&cnt=6&units=imperial&APPID=" + context.getString(R.string.str_weather_key);
                        tempExt1 = "°F";
                    }
                    int finalI2 = i;
                    StringRequest stringReq1 = new StringRequest(Request.Method.GET, url1, new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                AppWidgetManager appWidgetManager = (AppWidgetManager) context.getSystemService(AppWidgetManager.class);
                                appWidgetManager.updateAppWidget(appWidgetData.get(finalI2).getNumber(), finalRv4);
                                AlarmManager alarmManager = (AlarmManager) context.getSystemService(Context.ALARM_SERVICE);
                                Intent alarmIntent = new Intent(context, BetteryBroadcastReceiver.class);
                                PendingIntent broadcast = PendingIntent.getBroadcast(context, 0, alarmIntent, PendingIntent.FLAG_IMMUTABLE | PendingIntent.FLAG_UPDATE_CURRENT);
                                alarmManager.set(AlarmManager.RTC_WAKEUP, System.currentTimeMillis() + 2000, broadcast);
            ...
            } else if (appWidgetData.get(i).getPosition() == 5) {
                if (appWidgetData.get(i).getType() == 0) {
...
//                    rv.setImageViewBitmap(R.id.IvBackground, MyAppConstants.getRoundedCornerBitmap(BitmapFactory.decodeResource(context.getResources(), R.drawable.ic_widget_calendar2_large_bg), 30));
            ...
            } else if (appWidgetData.get(i).getPosition() == 6) {
                if (appWidgetData.get(i).getType() == 0) {
                    ...
                    intent.setData(Uri.parse(intent.toUri(Intent.URI_INTENT_SCHEME)));
                    rv.setRemoteAdapter(appWidgetData.get(i).getNumber(), R.id.GridCalendarLargeView, intent);
                    ...
                    if (!new MyAppPref(context).getString(MyAppPref.IS_DATE_LARGE_3, "").equalsIgnoreCase(currentDay + "/" + currentMonth + "/" + currentYear)) {
                        appWidgetManager.notifyAppWidgetViewDataChanged(appWidgetData.get(i).getNumber(), R.id.GridCalendarLargeView);
            ...
            } else if (appWidgetData.get(i).getPosition() == 7) {
                if (appWidgetData.get(i).getType() == 0) {
            ...
            } else if (appWidgetData.get(i).getPosition() == 8) {
                String city = appWidgetData.get(i).getCity();
                if (appWidgetData.get(i).getType() == 0) {
                    ...
                    StringRequest stringReq = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                AppWidgetManager appWidgetManager = (AppWidgetManager) context.getSystemService(AppWidgetManager.class);
                                appWidgetManager.updateAppWidget(appWidgetData.get(finalI1).getNumber(), finalRv1);
                                AlarmManager alarmManager = (AlarmManager) context.getSystemService(Context.ALARM_SERVICE);
                                Intent alarmIntent = new Intent(context, BetteryBroadcastReceiver.class);
                                PendingIntent broadcast = PendingIntent.getBroadcast(context, 0, alarmIntent, PendingIntent.FLAG_IMMUTABLE | PendingIntent.FLAG_UPDATE_CURRENT);
                                alarmManager.set(AlarmManager.RTC_WAKEUP, System.currentTimeMillis() + 2000, broadcast);
                        ...
                        StringRequest stringReq1 = new StringRequest(Request.Method.GET, url1, new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                try {
                                    ...
                                    AppWidgetManager appWidgetManager = (AppWidgetManager) context.getSystemService(AppWidgetManager.class);
                                    appWidgetManager.updateAppWidget(appWidgetData.get(finalI4).getNumber(), finalRv4);
                                    AlarmManager alarmManager = (AlarmManager) context.getSystemService(Context.ALARM_SERVICE);
                                    Intent alarmIntent = new Intent(context, BetteryBroadcastReceiver.class);
                                    PendingIntent broadcast = PendingIntent.getBroadcast(context, 0, alarmIntent, PendingIntent.FLAG_IMMUTABLE | PendingIntent.FLAG_UPDATE_CURRENT);
                                    alarmManager.set(AlarmManager.RTC_WAKEUP, System.currentTimeMillis() + 2000, broadcast);
            ...
            } else if (appWidgetData.get(i).getPosition() == 9) {
                String city = appWidgetData.get(i).getCity();
                if (appWidgetData.get(i).getType() == 0) {
            ...
            } else if (appWidgetData.get(i).getPosition() == 10) {
                String city = appWidgetData.get(i).getCity();
                if (appWidgetData.get(i).getType() == 0) {
            ...
            } else if (appWidgetData.get(i).getPosition() == 11) {
                if (appWidgetData.get(i).getType() == 0) {
                    //todo clock 1 small
                ...
                PendingIntent broadcast = PendingIntent.getBroadcast(context, 0, alarmIntent, PendingIntent.FLAG_IMMUTABLE | PendingIntent.FLAG_UPDATE_CURRENT);
                alarmManager.set(AlarmManager.RTC_WAKEUP, System.currentTimeMillis() + 2000, broadcast);
            } else if (appWidgetData.get(i).getPosition() == 12) {
                if (appWidgetData.get(i).getType() == 0) {
                    //todo clock 2 small
                ...
                PendingIntent broadcast = PendingIntent.getBroadcast(context, 0, alarmIntent, PendingIntent.FLAG_IMMUTABLE | PendingIntent.FLAG_UPDATE_CURRENT);
                alarmManager.set(AlarmManager.RTC_WAKEUP, System.currentTimeMillis() + 2000, broadcast);
            } else if (appWidgetData.get(i).getPosition() == 13) {
                if (appWidgetData.get(i).getType() == 0) {
                    //todo clock 3 small
                ...
                PendingIntent broadcast = PendingIntent.getBroadcast(context, 0, alarmIntent, PendingIntent.FLAG_IMMUTABLE | PendingIntent.FLAG_UPDATE_CURRENT);
                alarmManager.set(AlarmManager.RTC_WAKEUP, System.currentTimeMillis() + 2000, broadcast);
            } else if (appWidgetData.get(i).getPosition() == 14) {
                if (appWidgetData.get(i).getType() == 0) {
                    //todo clock 4 small
                ...
                PendingIntent broadcast = PendingIntent.getBroadcast(context, 0, alarmIntent, PendingIntent.FLAG_IMMUTABLE | PendingIntent.FLAG_UPDATE_CURRENT);
                alarmManager.set(AlarmManager.RTC_WAKEUP, System.currentTimeMillis() + 2000, broadcast);
            } else if (appWidgetData.get(i).getPosition() == 19) {
                if (appWidgetData.get(i).getType() == 0) {
                    //todo clock 9 small
                    rv = new RemoteViews(context.getPackageName(), R.layout.layout_widget_clock_text3_small);
                ...
                PendingIntent broadcast = PendingIntent.getBroadcast(context, 0, alarmIntent, PendingIntent.FLAG_IMMUTABLE | PendingIntent.FLAG_UPDATE_CURRENT);
                alarmManager.set(AlarmManager.RTC_WAKEUP, System.currentTimeMillis() + 2000, broadcast);
            } else if (appWidgetData.get(i).getPosition() == 20) {
                if (appWidgetData.get(i).getType() == 0) {
                ...
                PendingIntent broadcast = PendingIntent.getBroadcast(context, 0, alarmIntent, PendingIntent.FLAG_IMMUTABLE | PendingIntent.FLAG_UPDATE_CURRENT);
                alarmManager.set(AlarmManager.RTC_WAKEUP, System.currentTimeMillis() + 2000, broadcast);
            } else if (appWidgetData.get(i).getPosition() == 18) {
                if (appWidgetData.get(i).getType() == 0) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                        ...
                        cameraManager.registerTorchCallback(new CameraManager.TorchCallback() {
                            ...
                            public void onTorchModeChanged(@NonNull String cameraId, boolean enabled) {
                                ...
                                AppWidgetManager appWidgetManager = (AppWidgetManager) context.getSystemService(AppWidgetManager.class);
                                appWidgetManager.notifyAppWidgetViewDataChanged(appWidgetData.get(finalI3).getNumber(), R.id.IvTorch);
                            }
                ...
                PendingIntent broadcast = PendingIntent.getBroadcast(context, 0, alarmIntent, PendingIntent.FLAG_IMMUTABLE | PendingIntent.FLAG_UPDATE_CURRENT);
                alarmManager.set(AlarmManager.RTC_WAKEUP, System.currentTimeMillis() + 2000, broadcast);
            } else if (appWidgetData.get(i).getPosition() == 21) {
                if (appWidgetData.get(i).getType() == 0) {
            ...
            } else if (appWidgetData.get(i).getPosition() == 22) {
                if (appWidgetData.get(i).getType() == 0) {
                ...
                PendingIntent broadcast = PendingIntent.getBroadcast(context, 0, alarmIntent, PendingIntent.FLAG_IMMUTABLE | PendingIntent.FLAG_UPDATE_CURRENT);
                alarmManager.set(AlarmManager.RTC_WAKEUP, System.currentTimeMillis() + 2000, broadcast);
            } else if (appWidgetData.get(i).getPosition() == 23) {
