...
public class SmallWidgetProvider extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        if (CreateWidget) {
            appWidgetData = new AppWidgetData(0, MyAppConstants.Widget_Type_Id, -1, "", MyAppConstants.Temp_Id, MyAppConstants.IS_SIM_CARD);
        ...
        for (int i = 0; i < helper.getWidgets().size(); ++i) {
            ...
            if (helper.getWidgets().get(i).getType() == 0) {
                switch (helper.getWidgets().get(i).getPosition()) {
                    ...
                    case 7:
                        ...
                        rv.setOnClickPendingIntent(R.id.LlSmallWidget, configPendingIntent);
                        break;
                    case 1:
                    case 8:
                                            ...
                                            StringRequest stringReq = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
                                                ...
                                                public void onResponse(String response) {
                                                    try {
                                                        ...
                                                        appWidgetManager.updateAppWidget(helper.getWidgets().get(finalI).getNumber(), finalRv1);
                                            ...
                                            StringRequest stringReq = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
                                                ...
                                                public void onResponse(String response) {
                                                    try {
                                                        ...
                                                        new MyAppPref(context).putBoolean(MyAppPref.IS_WEATHER_1_ALARM, true);
                                                        alarmManager.set(AlarmManager.RTC_WAKEUP, System.currentTimeMillis() + 1000, broadcast);
                                                        appWidgetManager.updateAppWidget(helper.getWidgets().get(finalI1).getNumber(), finalRv1);
                                                    } catch (JSONException e) {
                                                        throw new RuntimeException(e);
                                                    }
                                                }
                                            ...
                                            StringRequest stringReq = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
                                                ...
                                                public void onResponse(String response) {
                                                    try {
                                                        ...
                                                        new MyAppPref(context).putBoolean(MyAppPref.IS_WEATHER_1_ALARM, true);
                                                        alarmManager.set(AlarmManager.RTC_WAKEUP, System.currentTimeMillis() + 1000, broadcast);
                                                        appWidgetManager.updateAppWidget(helper.getWidgets().get(finalI2).getNumber(), finalRv1);
                                                    } catch (JSONException e) {
                                                        throw new RuntimeException(e);
                                                    }
                                                }
