...
public class SmallPhotoWidgetProvider extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] iArr) {
        ...
        AppWidgetData appWidgetData = new AppWidgetData(0, MyAppConstants.Widget_Type_Id, -1, "", MyAppConstants.Temp_Id, MyAppConstants.IS_SIM_CARD);
    ...
    public static void updateWidgetView(int p, Context context, Intent intent) {
        ...
        AppWidgetMaster mainWidget = instance.getWidgetMaster(Pos);
        if (Pos != -1) {
